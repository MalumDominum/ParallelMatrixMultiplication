...
public class FoxMultiplierWithThread : ParallelMatrixMultiplier
{
    public FoxMultiplierWithThread(double[,] matrixA, double[,] matrixB) : base(matrixA, matrixB) { }
    ...
    private protected MatrixBlock[,] InitBlocks(int iterations)
    {
